...
<v-container fill-height class="text-center" fluid style="background:linear-gradient(to right, #24243e, #141E30, #0f0c29);">
    ...
    <v-row
     ...
     <v-row
      ...
      <v-col cols=10>
        ...
        <p  class="overline grey--text mt-6">宗旨：工作中解决的问题，随手学到的知识，帮助小伙伴时的乐趣。
        </p>
    ...
    <v-row
     ...
     <v-row
      ...
      >
      <v-col cols=10>
        <v-text-field  dark dense color='indigo' prepend-icon="fa-user-check" label="电子邮件"  v-model="model.username"  placeholder="rwplus@github.com"></v-text-field>
        </v-text-field>
        </v-col>
        </v-row>
            <v-row
        ...
        <v-text-field  dark dense color='indigo' prepend-icon="fa-key" label="密码" type="password" v-model="model.password" placeholder="password">
         ...
         <v-btn small dark dense  outlined rounded dark @click="login" color="deep-orange">登录</v-btn>
